    ...
    <>
      <div className="min-h-screen bg-gradient-to-br from-primary/5 to-secondary">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                ...
                className="gap-2 bg-gradient-to-r from-orange-500 to-pink-600 hover:from-orange-600 hover:to-pink-700 text-white"
              >
                <svg
          ...
          {error && (
            <div
              className="bg-destructive/10 border border-destructive text-destructive px-4 py-3 rounded-lg mb-6 flex items-center gap-2"
              role="alert"
            >
              <span>Error:</span>
              <span>{error}</span>
                ...
                {loadingTodos ? (
                  ...
                  <div className="text-center py-16">
                    ...
                    <p className="text-muted-foreground max-w-md mx-auto">
                      Great job! You've completed all your tasks. Add a new task
                      to get started.
                    </p>
                  </div>
                ) : (
              ...
              <TabsContent value="completed" className="mt-6">
                {loadingTodos ? (
                  ...
                  <div className="text-center py-16">
                    ...
                    <p className="text-muted-foreground max-w-md mx-auto">
                      Start completing your tasks to see them appear here. You
                      got this!
                    </p>
                  </div>
                ) : (
