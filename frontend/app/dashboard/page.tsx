      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-2">Welcome to your personalized workspace</p>
          </div>
        ...
        <div className="mb-10">
          <h2 className="text-2xl font-bold text-foreground mb-2">Welcome back, {user?.email}!</h2>
